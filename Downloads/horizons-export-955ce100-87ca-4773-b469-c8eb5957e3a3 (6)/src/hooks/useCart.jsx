...
export const CartProvider = ({ children }) => {
  ...
  const updateQuantity = useCallback((variantId, newQuantity) => {
      ...
      if (itemToUpdate && itemToUpdate.variant.manage_inventory && newQuantity > itemToUpdate.variant.inventory_quantity) {
          // Here you might want to show a toast message to the user
          console.warn(`Cannot add more than ${itemToUpdate.variant.inventory_quantity} items.`);
          return; 
      }
