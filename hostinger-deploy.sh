...
# 🚀 Script de déploiement Hostinger - Next.js
# Usage: ./hostinger-deploy.sh

set -e

echo "🚀 Déploiement Next.js sur Hostinger"
echo "===================================="
...
echo "Build date: $(date)" > public_html/deploy-info.txt
echo "Commit: $(git rev-parse HEAD)" >> public_html/deploy-info.txt

print_success "Fichiers de déploiement préparés dans le dossier 'public_html/'"
...
echo ""
echo "1. Uploadez le contenu du dossier 'public_html/'"
